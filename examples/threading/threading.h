...
struct thread_data{
     ...
     */
    // Sleep time before obtaining the mutex	
    int wait_ms_before_obtain;
    // Sleep time before releasing the mutex
    int wait_ms_before_release;
    
    //pointer to the mutex which is to be obtained
